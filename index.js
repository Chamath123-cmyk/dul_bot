...
const ownerNumber = "94776960561@s.whatsapp.net";
...
async function connectToWhatsApp() {
  ...
  sock.ev.on("messages.upsert", async (m) => {
    ...
    if (isOwner) {
      ...
      if (lowerText === ".block") {
        await sock.sendMessage(from, {
          text: "🚫 ඔබව Dulina විසින් Block කරනු ලැබුවා. මින් ඉදිරියට ඔබට පණිවිඩ එවීමට නොහැක.",
        });
      ...
      if (lowerText === ".unblock") {
        ...
        return await sock.sendMessage(from, {
          text: "✅ ඔබව Dulina විසින් සාර්ථකව Unblock කරනු ලැබුවා.",
        });
      }
    ...
    if (lowerText === ".owner") {
      const ownerImg =
        "https://raw.githubusercontent.com/Chamath123-cmyk/dul_bot/main/owner.jpeg";
    ...
    if (lowerText === "2" || lowerText === "3") {
      const replyRest = `Dulina එනකම් රැඳී සිටින්න.🕐 ඔහු ඉක්මනින් ඔබව සම්බන්ධ කර ගනීවි.\n\n🤖_Chamath's Bot Assistant_\n© Powered by 🔰*Chamath N Dissanayake*`;
